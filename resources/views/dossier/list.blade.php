        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ajouter nouveau dossier</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{route('dossier.add')}}">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="type_dossier">type_dossier</label>
                    <input type="text" class="form-control {{ $errors->has('type_dossier') ?  'is-invalid':'' }} " value="{{ old('type_dossier') }}"   name="type_dossier"  placeholder="Entrer type_dossier">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="{{route('dossier.edit', ['id' => $doss->id])}}" class="btn btn-info"><i class="fas fa-pencil-alt"></i></a> |  <a href="{{route('dossier.delete', ['id' => $doss->id])}}" onclick="return confirm('Voulez vous supprimer?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
