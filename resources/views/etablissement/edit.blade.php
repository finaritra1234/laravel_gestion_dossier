        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Modifier etablissement</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{route('etablissement.edit.submit',['id' => $etabl->id ])}}">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="cisco">Cisco</label>
                    <input type="text" class="form-control {{ $errors->has('cisco') ?  'is-invalid':'' }} " value="{{$etabl->cisco }}"   name="cisco"  placeholder="Entrer cisco">
                    @if ($errors->has('cisco'))
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('nom_etabl') ?  'is-invalid':'' }}" value="{{$etabl->nom_etabl }}"    name="nom_etabl"  placeholder="Entrer nom etablissement">
                 ...
                 @endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('adresse_etabl') ?  'is-invalid':'' }} " value="{{$etabl->adresse_etabl }}"   name="adresse_etabl"  placeholder="Entrer adresse etablissement">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="{{route('etablissement.edit', ['id' => $etabl->id])}}" class="btn btn-info">Modifier</a> |  <a href="{{route('etablissement.delete', ['id' => $etabl->id])}}" onclick="return confirm('Voulez vous supprimer?')" class="btn btn-danger">Supprimer</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
