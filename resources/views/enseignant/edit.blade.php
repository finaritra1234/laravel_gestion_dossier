        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="card">
              ...
              <!-- form start -->
              <form method="POST" action="{{route('enseignant.edit.submit',['id'=>$ens->id])}}" name="myForm" onsubmit="return ima()">
                  @csrf
                <div class="card-body">
                   <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('im') ?  'is-invalid':'' }} " value="{{ $ens->im }}"  id="im"  name="im"  placeholder="Entrer im">
                            @if ($errors->has('im'))
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('nom') ?  'is-invalid':'' }}" value="{{ $ens->nom }}" id="nom"  name="nom"  placeholder="Entrer  nom">
                            @if ($errors->has('nom'))
                            <span class="help-block">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('prenom') ?  'is-invalid':'' }}" value="{{ $ens->prenom }}"    name="prenom"  placeholder="Entrer prenom">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control {{ $errors->has('date_naiss') ?  'is-invalid':'' }}" value="{{ $ens->date_naiss }}"   name="date_naiss"  placeholder="Entrer date de naissance ">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('lieu_naiss') ?  'is-invalid':'' }}" value="{{ $ens->lieu_naiss }}"   name="lieu_naiss"  placeholder="Entrer lieu de naissance">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('corps') ?  'is-invalid':'' }}" value="{{ $ens->corps }}"    name="corps"  placeholder="Entrer le corp">
                            @if ($errors->has('corps'))
                            <span class="help-block">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('grad') ?  'is-invalid':'' }}" value="{{ $ens->grad }}"   name="grad"  placeholder="Entrer grad">
                            @if ($errors->has('grad'))
                            <span class="help-block">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('indice') ?  'is-invalid':'' }}" value="{{ $ens->indice }}"    name="indice"  placeholder="Entrer indice">
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('acte') ?  'is-invalid':'' }}"value="{{ $ens->acte }}"   name="acte"  placeholder="Entrer acte">
                            @if ($errors->has('acte'))
                            <span class="help-block">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control {{ $errors->has('etablissement_id') ?  'is-invalid':'' }}"     name="etablissement_id" >
                               <option value="{{ $liste_etab->id }}">{{ $liste_etab->cisco }}</option>
