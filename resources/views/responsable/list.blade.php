        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ajouter nouveau responsable</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{route('responsable.add')}}">
                  @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('desc') ?  'is-invalid':'' }}" value="{{ old('desc') }}"    name="desc"  placeholder="Entrer nom respissement">
                    @if ($errors->has('desc'))
                    <span class="help-block">
