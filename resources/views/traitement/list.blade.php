                  ...
                  <div id="table">
                    ...
                    <div class="col-12 table-responsive">
                        ...
                        <tbody>
                            ...
                            <td> {{ \Carbon\Carbon::parse($ens->date_depot)->formatLocalized('%d %B %Y')}}  </td>


                            <td>
                                    @if  ($ens->date_envoye == null)
                                    <span class="badge badge-info">Pas encore transferer</span>
                                    @else
                                        {{ \Carbon\Carbon::parse($ens->date_envoye)->formatLocalized('%d %B %Y') }}
                                    @endif
                            </td>
                            <td>
                                    ...
                                    @else
                                        {{ \Carbon\Carbon::parse($ens->date_retour)->formatLocalized('%d %B %Y')}}
                                    @endif
                            </td>
                            <td>
                                    @if ($ens->status == null)
